...
%% 时域特征提取 退化指标的建立
[me,ma,mi,st,fc,pk ,rmse ,fgfz ,sf ,cf ,If ,Clf ,Kv]=time_feaext(yw);
[me1,ma1,mi1,st1,fc1,pk1,rmse1,fgfz1,sf1,cf1,If1,Clf1,Kv1]=time_feaext(yw1);
[me2,ma2,mi2,st2,fc2,pk2,rmse2,fgfz2,sf2,cf2,If2,Clf2,Kv2]=time_feaext(yw2);
[me3,ma3,mi3,st3,fc3,pk3,rmse3,fgfz3,sf3,cf3,If3,Clf3,Kv3]=time_feaext(yw3);
[me4,ma4,mi4,st4,fc4,pk4,rmse4,fgfz4,sf4,cf4,If4,Clf4,Kv4]=time_feaext(yw4);
